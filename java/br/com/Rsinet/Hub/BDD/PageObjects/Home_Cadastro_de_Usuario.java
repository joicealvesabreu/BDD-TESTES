...
public class Home_Cadastro_de_Usuario {
	...
	public void nome_usuario(String sNome) throws Exception {
	...
	public void pais_Usuario() {
		WebElement element = paisUsuario;
	...
	public void variaveisstrings() throws Exception {
		...
		String sCep = ExcelUtils.getCellData(1, 9);
	}
}
